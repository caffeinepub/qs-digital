            ...
            <div className="max-w-5xl mx-auto">
              ...
              <div className="grid sm:grid-cols-2 gap-6 mt-6">
                <motion.a
                  ...
                  viewport={{ once: true }}
                  transition={{ duration: 0.5 }}
                  className="rounded-2xl p-8 flex flex-col items-center text-center gap-4 text-white cursor-pointer"
                  style={{
                    background:
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-blue-100 text-sm mt-1">Follow Us</div>
                  </div>
                </motion.a>
                <motion.a
                  href={INSTAGRAM_URL}
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-pink-100 text-sm mt-1">@hafij__hq</div>
                  </div>
                </motion.a>
              </div>
              <motion.div
